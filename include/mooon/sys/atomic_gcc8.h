 ...
 */
typedef volatile long atomic8_t;
 ...
 * other cases.
 */
static __inline__ int atomic8_sub_and_test(long i, atomic8_t *v)
{
 ...
 */ 
static __inline__ int atomic8_add_negative(long i, atomic8_t *v)
{
 ...
 */
static __inline__ int atomic8_add_return(long i, atomic8_t *v)
{
	return __sync_add_and_fetch(v, i);
}

static __inline__ int atomic8_sub_return(long i, atomic8_t *v)
{
